...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: [`${MOD}+C`], description: 'Copy selection (paste survives template switch)' },
      { keys: [`${MOD}+V`], description: 'Paste copied elements (offset slightly)' },
      { keys: [`${MOD}+G`], description: 'Group selected elements' },
      { keys: [`${MOD}+Shift+G`], description: 'Ungroup selected group(s)' },
